<template>
  <AppLayout title="Edit Pendapatan Fasilitas">
    <div class="py-12">
      <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
          <div class="p-6">
            <div class="flex justify-between items-center mb-6">
              <h2 class="text-2xl font-bold text-gray-900">🏢 Edit Pendapatan Fasilitas</h2>
              <Link
...
const form = reactive({
  date: props.facility.date,
  amount: props.facility.amount,
...
function submit() {
  ...
  router.put(route('facilities.update', props.facility.id), form, {
    onFinish: () => {
