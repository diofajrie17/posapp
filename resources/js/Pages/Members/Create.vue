<template>
  <AppLayout title="Tambah Member">
    <div class="max-w-2xl mx-auto bg-white rounded-2xl shadow-lg p-8">
      <!-- Judul -->
      <div class="mb-6">
        <h1 class="text-3xl font-bold text-gray-800 mb-2">Tambah Member 👤</h1>
        <p class="text-gray-600">Lengkapi form berikut untuk menambahkan member baru</p>
      </div>
      ...
      <form @submit.prevent="submit" class="space-y-6">
        ...
        <div class="flex gap-4">
          ...
          >
            ...
            <span v-else>Simpan Member</span>
          </button>
